...
rsarray <- readRDS(here("out", "multitask", paste0("taskaxis_euclidean-unbiased_unpre.RDS")))
...
stats.subjs %>%
  ...
  labs(y = "group-mean cross-task task-rest discriminability\n(cross-validated cosine simil)", title = "discriminability by train/test split (e.g., run12 == train1test2)")
