---
title: 'multitask pattern similarity: high versus low, cross-validated euclidean -- cross-task'
...
* cross-validated euclidean distance on hi-lo contrast
...
* parcel average cross-task HiLo discrim
...
stats.subjs %>%
  ...
  labs(y = "group-mean cross-task hi-lo discriminability\n(cross-validated euclidean)", title = "discriminability by train/test split (e.g., run12 == train1test2)")
...
contrasts.subjs.35 %>%
  ...
  labs(y = "mean cross-task-validated euclidean distance")
