...
```{r parcel_contrasts_betas, fig.height = 8, fig.width = 10}
...
```{r parcel_contrasts_tstats, fig.height = 8, fig.width = 10}
...
```{r parcel_contrasts_dmcc55b, fig.height = 8, fig.width = 10}
...
for (task.i in tasks) {
  ...
  print(p.contrast.parcel.t.dmcc55b)
...
```{r brains, fig.height = 15, fig.width = 15, results = "asis"}
