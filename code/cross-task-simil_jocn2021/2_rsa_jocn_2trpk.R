...
univa <- readRDS(here("out", "cross-task-simil_jocn2021", paste0("mean-biased_unpre_jocn_2trpk.RDS")))
unifo <- readRDS(here("out", "cross-task-simil_jocn2021", paste0("ssq-biased_unpre_jocn_2trpk.RDS")))
...
fwrite(
  stats.subjs,
  here("out", "cross-task-simil_jocn2021",  paste0("subjs_jocn.csv"))
)

fwrite(
  stats.subjs.univa,
  here("out", "cross-task-simil_jocn2021",  paste0("subjs_jocn_mean.csv"))
)

fwrite(
  stats.subjs.unifo,
  here("out", "cross-task-simil_jocn2021",  paste0("subjs_jocn_ssq.csv"))
)
